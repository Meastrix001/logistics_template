export const i18n_est = {
  ...
  about: {
    ...
    aboutme6: `Minu juurde vahatama tulles ei ole vaja hirmu või piinlikust tunda. Meie kõigi kehad on erinevad ning see on täiesti okei. Vastan meeleldi igale tekkivale küsimusele kas nõu, jõu või soovitustega!`,
    aboutme7: `Kohtume juba stuudios!`,
